...
function doSearch() {
    ...
    if(null==opts.url||""==opts.url){
        opts.url="<%=path%>/recharge/selectRecharge.do";
    }
...
<table id="VIP_Account" title="VIP充值记录" class="easyui-datagrid" 
	...
	<thead> 
		<tr> 
		    <th field="vip_ID" width="80">会员号</th>
			<th field="discount_price" width="80">充值金额</th>
			<th field="recharge_Time" width="80">充值时间</th>
