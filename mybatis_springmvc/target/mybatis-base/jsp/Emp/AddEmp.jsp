...
<form id="AddEmpForm" method="post"  style="width:100%;">
		<table>
			<tr>
				<td>用户名:</td>
				<td><input name="employee_Name" class="easyui-validatebox" validtype="NotEmpty" type="text" required="true"></input></td>
			</tr>
			<tr>
				<td>用户密码:</td>
				<td><input name="employee_Password" class="easyui-validatebox" validtype="NotEmpty" type="password" required="true"></input></td>
			</tr>
			<tr>
				<td>再输入一次密码:</td>
				<td><input name="lemployee_Password" class="easyui-validatebox" validtype="NotEmpty" type="password" required="true"></input></td>
			</tr>
			<tr>
				<td>用户等级:</td>
				<td><input name="employee_Level" class="easyui-validatebox" validtype="integer" type="text" required="true"></input></td>
			</tr>
			</table>
