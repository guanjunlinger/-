...
<script type="text/javascript">
    function doSearch() {
        var opts=$("#Discount").datagrid("options");
        if(null==opts.url||""==opts.url){
            opts.url="<%=path%>/discount/selectByVIP_Level_ID.do";
        }

        $('#Discount').datagrid('load',{
            vip_Level_ID: $('#vip_Level_ID').val(),
        });
    }
    ...
    function saveDis(){
        $('#EditDisForm').form('submit',{
            url:"<%=path%>/discount/updateVipDiscount.do",
            onSubmit: function(){
...
<div id="toolbar">
    <div id="tb" style="padding:3px">
        <span>会员等级ID:</span>
        <input id="vip_Level_ID" style="line-height:26px;border:1px solid #ccc">
...
<div id="dlg" class="easyui-dialog" style="width:100%;height:100%;" closed="true" buttons="#dlg-buttons">
    <form id="EditDisForm" method="post"  style="width:100%;">
        <table>
            ...
            <tr>
                <td>会员推拿次数:</td>
                <td><input name="discount_count" class="easyui-validatebox" validtype="integer" type="text"></input></td>
            </tr>
            <tr>
                <td>会员推拿充值价格:</td>
                <td><input name="discount_price" class="easyui-validatebox" validtype="integer" type="text"></input></td>
            </tr>
        </table>
    </form>
    <div id="dlg-buttons">
