					...
					<li>
						...
						<ul>
							<li>
								<span>充值优惠信息</span>
								<ul>
									<li><span><a href="#" onclick="addTab('添加优惠信息','<%=path%>/jsp/Discount/AddDiscount.jsp')">添加优惠信息</a></span></li>
									<li><span><a href="#" onclick="addTab('查看优惠信息','<%=path%>/jsp/Discount/LookDiscount.jsp')">查看优惠信息</a></span></li>
								</ul>
							</li>
